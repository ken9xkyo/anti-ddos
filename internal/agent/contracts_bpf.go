...
var ExpectedMaps = map[string]MapExpectation{
	...
	"whitelist_service_v4_a":        {Type: ebpf.LPMTrie, MaxEntries: 65536},
	"whitelist_service_v4_b":        {Type: ebpf.LPMTrie, MaxEntries: 65536},
	"blacklist_v4_a":                {Type: ebpf.LPMTrie, MaxEntries: 1000000},
	"blacklist_v4_b":                {Type: ebpf.LPMTrie, MaxEntries: 1000000},
	"blacklist_service_v4_a":        {Type: ebpf.LPMTrie, MaxEntries: 65536},
	"blacklist_service_v4_b":        {Type: ebpf.LPMTrie, MaxEntries: 65536},
	"udp_src_port_blocks_a":         {Type: ebpf.Hash, MaxEntries: 4096},
	"udp_src_port_blocks_b":         {Type: ebpf.Hash, MaxEntries: 4096},
	"udp_src_port_service_blocks_a": {Type: ebpf.Hash, MaxEntries: 16384},
	"udp_src_port_service_blocks_b": {Type: ebpf.Hash, MaxEntries: 16384},
	...
	"rate_state_v2":                 {Type: ebpf.Hash, MaxEntries: 2000000},
